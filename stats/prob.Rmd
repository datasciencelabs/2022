...
In a probability class you will learn $S$ follows a binomail distribution and that the binomial distribution is approximated with the normal distribution.
