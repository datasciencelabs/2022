...
-   When we took a 25 bead sample size, the confidence interval for the spread is:

```{r}
N <- 25
x_hat <- 0.48
(2 * x_hat - 1) + c(-1.96, 1.96) * 2 * 
...
-   Keep in mind that there is a close connection between p-values and confidence intervals.
