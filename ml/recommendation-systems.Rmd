...
- Let's explore where we made mistakes in our first model, using only movie effects $b_i$.
...
- Many of them have large predictions.

- Let's look at the top 10 worst and best movies based on $\hat{b}_i$.
