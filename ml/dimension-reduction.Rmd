...
- In the plot below red represents high values and blue negative values (later, in Section \@ref(factor-analysis), we learn why we call these weights and patterns):
...
```{r dist-approx-4, message = FALSE, fig.height = 3, fig.width = 3, out.width="50%", eval=FALSE} 
...
```{r dist-approx-4-run, message = FALSE, fig.height = 3, fig.width = 3, out.width="50%", echo=FALSE} 
d_approx <- dist(pca$x[, 1:2]) 
qplot(d, d_approx) + geom_abline(color="red") 
``` 
